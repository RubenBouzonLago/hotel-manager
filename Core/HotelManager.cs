    ...
    public static class HotelManager
    {
        ...
        public static void CargarDatos()
        {
            ...
            if (ComodidadesDisponibles.Count == 0)
            {
                ...
                ComodidadesDisponibles.Add(new Comodidad("Aire Acondicionado", "Control de temperatura"));
                ComodidadesDisponibles.Add(new Comodidad("Jacuzzi", "Baño con hidromasaje"));
